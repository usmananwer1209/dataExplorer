...
function ListAsComp(){
	...
	$.post('termajaxdata_c',{'Work':'ListAsComp','tbl':'company','CompName':CompName},
	function(data)
	{
...
function selectlist(Work){
	...
	$.post('termajaxdata_c',{'Work':Work,'tbl':'company','atbValue':atbValue},
	function(data)
	{
	var lists = data.split("#@#");
	if(Work=='SectorList'){ 
...
function ListOfDropdown(table,divid,rdGroup){
	...
	$.post('termajaxdata_c',{'Work':'ListOfDropdown','table':table,'chkdvalue':chkdvalue,'filter':filter,'rdGroup':rdGroup},function(data){	
...
$.post('termajaxdata_c',{'Work':'getDetail','tbl':'kpi','Id':Id},
	function(data)
...
if(selectId=='SelectedKpi'){
  ...
  for (var i=0; i<selectobject.length; i++){
     ...
     values+='"';
$.post('termajaxdata_c',{'Work':'DataSave','tbl':table,'ListName':ListName,'values':values,'status':status},
	function(data)
	{ alert(data); });	}
...
$.post('termajaxdata_c',{'Work':'ShowList','tbl':table,'selectId':selectId},
	function(data)
...
$.post('termajaxdata_c',{'Work':'getTable','valuesComp':valuesComp,'valuesKpi':valuesKpi,'Anual':Anual,'Quarterly':Quarterly,'Range':Range},
	function(data)
