...
class Card extends abstract_controller {
    ...
    public function get_data_json_all_periods($segment = 'year') {
        $s_companies = $_REQUEST['valuesComp'];
        $s_kpis = $_REQUEST['valuesKpi'];
        // $s_companies = $this->input->get('companies');
        // $s_kpis = $this->input->get('kpis');
        // $id = $this->input->get('id');
    ...
    public function getrange() {
         ...
         $query_min = $this->rperiods->get_min_period();
        foreach ($query_min as $min)
            ;
        $query_max = $this->rperiods->get_max_period();
