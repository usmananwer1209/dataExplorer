													...
													<div class="col-md-10 blue-custom-padd">	
														<div class="custom-checkbox-col">
															<div class="checkbox custom-checkbox-blue" >
																<input class="checkboxx" type="checkbox" id="chkAmt1" name="chkAmt1" value="Between1And10M" onchange="selectLimts();ListOfDropdown('company','ListOfDropdown')">
																<label for="chkAmt1"> <?="<10M"?> </label>	
															</div>
														</div>	
														<div class="custom-checkbox-col">
															<div class="checkbox custom-checkbox-blue" >
																<input class="checkboxx" type="checkbox" id="chkAmt2" name="chkAmt2" value="Between10MAnd50M" onchange="selectLimts();ListOfDropdown('company','ListOfDropdown')" >
																<label for="chkAmt2"> 10-50M </label>	
															</div>
														</div>
														<div class="custom-checkbox-col">
															<div class="checkbox custom-checkbox-blue" >
																<input class="checkboxx" type="checkbox" id="chkAmt3" name="chkAmt3" value="Between50MAnd100M" onchange="selectLimts();ListOfDropdown('company','ListOfDropdown')" >
																<label for="chkAmt3"> 50-100M </label>	
															</div>
														</div>	
														<div class="custom-checkbox-col">
															<div class="checkbox custom-checkbox-blue" >
																<input class="checkboxx" type="checkbox" id="chkAmt4" name="chkAmt4" value="Between100MAnd200M" onchange="selectLimts();ListOfDropdown('company','ListOfDropdown')" >
																<label for="chkAmt4"> 100-200M </label>	
															</div>
														</div>
														<div class="custom-checkbox-col">
															<div class="checkbox custom-checkbox-blue" >
																<input class="checkboxx" type="checkbox" id="chkAmt5" name="chkAmt5" value="Between200MAnd500M" onchange="selectLimts();ListOfDropdown('company','ListOfDropdown')" >
																<label for="chkAmt5"> 200-500M </label>	
															</div>
														</div>	
														<div class="custom-checkbox-col">
															<div class="checkbox custom-checkbox-blue" >
																<input class="checkboxx" type="checkbox" id="chkAmt6" name="chkAmt6" value="Between500MAnd1B" onchange="selectLimts();ListOfDropdown('company','ListOfDropdown')" >
																<label for="chkAmt6"> 500M-1B </label>	
															</div>
														</div>		
														<div class="custom-checkbox-col">
															<div class="checkbox custom-checkbox-blue" >
																<input class="checkboxx" type="checkbox" id="chkAmt7" name="chkAmt7" value="Between1BAnd5B" onchange="selectLimts();ListOfDropdown('company','ListOfDropdown')" >
																<label for="chkAmt7"> 1-5B </label>	
															</div>
														</div>
														<div class="custom-checkbox-col">
															<div class="checkbox custom-checkbox-blue" >
																<input class="checkboxx" type="checkbox" id="chkAmt8" name="chkAmt8" value="Between5BAnd10B" onchange="selectLimts();ListOfDropdown('company','ListOfDropdown')" >
																<label for="chkAmt8"> 5-10B </label>	
															</div>
														</div>	
														<div class="custom-checkbox-col">
															<div class="checkbox custom-checkbox-blue" >
																<input class="checkboxx" type="checkbox" id="chkAmt9" name="chkAmt9" value="Between10Band50B" onchange="selectLimts();ListOfDropdown('company','ListOfDropdown')" >
																<label for="chkAmt9"> 10-50B </label>	
															</div>
														</div>
														<div class="custom-checkbox-col">
															<div class="checkbox custom-checkbox-blue" >
																<input class="checkboxx" type="checkbox" id="chkAmt10" name="chkAmt10" value="Between50BAnd100B" onchange="selectLimts();ListOfDropdown('company','ListOfDropdown')" >
																<label for="chkAmt10"> 50-100B </label>	
															</div>
														</div>	
														<div class="custom-checkbox-col">
															<div class="checkbox custom-checkbox-blue" >
																<input class="checkboxx" type="checkbox" id="chkAmt11" name="chkAmt11" value="GreaterThan100B" onchange="selectLimts();ListOfDropdown('company','ListOfDropdown');" >
										...
										<div class="row custom-form-row-blue custom-form-control-blue custom-form-control-3">
											<div class="col-md-12">
												<div class="radio radio-success">
													<div class="row">
														<div class="col-md-4">
															<input type="radio" id="decision_category" name="period1" value="decision_category" checked="checked" onclick="ListOfDropdown('kpi','ListKpiDropdown')">
															<label for="decision_category">Group by Decision Category</label>
														</div>
														<div class="col-md-4">
															<input type="radio" id="financial_category" name="period1" 
                                                            value="financial_category" onclick="ListOfDropdown('kpi','ListKpiDropdown')">
...
?>        
								...
								<div class="row ">
									<div class="col-md-12">
										<div class="table-responsive dataexport_table" style="width:100%;overflow:auto;">
                                        <?php
// require_once $folder.'/explore/container.php';

										?>
<table class="table table-striped table-bordered table-hover" id="DataTable"  style="overflow:scroll">
