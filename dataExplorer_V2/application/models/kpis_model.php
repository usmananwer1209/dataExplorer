...
class Kpis_model extends Abstract_model {
    ...
    public function get_kpis($order_group, $Id, $name, $idValue, $SelectedList) {

        return $get_outer = $this->db->order_by("name", "asc")->get('kpi')->result();
    }

    public function get_grouped_kpis($order_group, $Id, $name, $idValue, $SelectedList) {
       return $this->db->group_by($order_group)->order_by($order_group, "asc")->get('kpi')->result();
    }

    public function get_inner_list($order_group, $chkdvalue, $filter, $outer_order_group, $name) {
        ...
        return $get_inner = $this->db->like($order_group, $outer_order_group)->order_by($name, "asc")->get('kpi')->result();
    }
