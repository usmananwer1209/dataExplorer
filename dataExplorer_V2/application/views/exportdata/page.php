...
//                                                $get_sector = $this->db->group_by("sic")->get('company')->result();
                                    ...
                                    <div class="row custom-form-row-blue blue-border" id="ListOfDropdown" style="height:268px;overflow:auto;">
                                    </div>
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="kpi">
                            <div class="row">
                                <div class="col-md-8">	
                                    ...
                                    <div class="row custom-form-row-blue blue-border" id="ListKpiDropdown" style="height:475px;overflow:auto;">
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="export">
                            ...
                            <div class="row ">
                                <div class="col-md-12">
                                    <div class="table-responsive dataexport_table" style="width:100%;overflow:auto;height:308px;" id="tabledata">
                                        <?php
