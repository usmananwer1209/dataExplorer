        ...
        <div class="grid-body no-border">
          <div class="row">
            <div class="col-md-8 col-sm-8 left">
            	<div class="col-md-1"><label for="search_company" class="search-labels">Search</label></div>
                ...
                <div class="col-md-1 no-padding-left"><button class="btn btn-go" id="btn_go_company">Go</button></div>
